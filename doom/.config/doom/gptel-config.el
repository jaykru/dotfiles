...
(define-tool
  ...
  :function (lambda ()
              (mapconcat #'(lambda (w)
                         ...
                         (window-list)
                         ", "))
  :description "List buffers currently visible in the Emacs session. This is a great way to find out what the user is talking about. Use it if you're unsure about what the query."
  :args '()
  :category "emacs")
...
(defun apply-unified-diff (diff-text buffer)
