...
** Mail
    #+begin_src emacs-lisp :tangle yes
      ...
      '(
        (:name "inbox" :query "(date:month.. and not to:@sifive.com and not tag:sent) or (date:month.. and to:sifive.com and not [JIRA]) and (not tag:sent)" :key "i")
	(:name "work" :query "(to:sifive.com)" :key "w")
        (:name "banking"
