...
(eval-after-load 'magit '(progn (define-key magit-mode-map "@" 'magit-annex-dispatch-or-init) (transient-append-suffix 'magit-dispatch "%" '("@" "Annex" magit-annex-dispatch-or-init))))
